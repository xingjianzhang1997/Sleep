...
# 设置数据保存的
dataPath = r'C:\ZXJ\python\DL\1_Sleep\0_data\00_rawdata\sleep-cassette'  # sleep-telemetry
savePath = r'C:\ZXJ\python\DL\1_Sleep\0_data\05_SC_EOG_horizontal'       
select_ch = "EOG horizontal"  # EEG Fpz-Cz or EEG Pz-Oz

# flag设置
flag_data_balance = True
